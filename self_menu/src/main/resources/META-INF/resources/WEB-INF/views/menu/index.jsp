...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/gaoweijian/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/gaoweijian/menu/js/jquery.js"></script>
<script type="text/javascript" src="/gaoweijian/menu/js/vue.js"></script>
<script type="text/javascript" src="/gaoweijian/menu/js/menu.js"></script>
