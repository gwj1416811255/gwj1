package org.gaoweijian.weixin.library.comtroller;

import org.gaoweijian.weixin.library.domain.DebitList;
import org.gaoweijian.weixin.library.service.LibraryService;
...
@Controller
@RequestMapping("/gaoweijian/library/debit")
...
public class DebitController {
	...
	public String debit(@RequestParam("id") String id, WebRequest request) {
		...
		return "redirect:/gaoweijian/library/debit/list";
	}
